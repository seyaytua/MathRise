...
このプロンプトは、重要トピックからレッスン一覧を作成します。

## 使い方

1. `output/<単元名>/stage0/keyTopics.json` を開く
2. このプロンプトの [keyTopics.json] 部分に内容を挿入
3. 教科書の目次を準備
4. このプロンプトを実行
5. 生成されたJSONを `output/<単元名>/stage1/lesson-map.json` に保存
